...
export const api = {
  ...
  async startImagesAnalysis() {
    ...
    return await response.json(); // returns { job_id, total_images }
  },
  async getImagesAnalysisStatus(jobId) {
    const response = await fetch(`${API_BASE}/analyze/images/${jobId}`);
